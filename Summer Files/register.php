...
<fieldset class="ui-corner-all">
	...
	<table>
		...
		<tr>
			...
			<td>
			  <input type="password" name="password1" id="password1"  class="wide password"  data-indicator="pwindicator" />
			  <div id="pwindicator">
            <div class="bar"></div>
            <div class="label"></div>
        </div>
       ...
       <script type="text/javascript" src="https://www.google.com/recaptcha/api/challenge?k=6Le_gNsSAAAAAMQuZZBUxdtnFeSWqNLW_AwAxEc4"></script>
			 <noscript>
				 <iframe src="https://www.google.com/recaptcha/api/noscript?k=6Le_gNsSAAAAAMQuZZBUxdtnFeSWqNLW_AwAxEc4" height="300" width="500" frameborder="0">
         </iframe><br />
