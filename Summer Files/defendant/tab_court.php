<fieldset>
	...
	<?
  $court_caseID = $defendant->checkCourt();
  ...
  <table class="listing" id="court-listing">
    ...
    <tbody>
    <?
    foreach( $court_caseID as $key => $row)
    {
      $court = new Court( $user_programID );
      $court->getFromCaseID( $row["court_caseID"] );
      ...
      ?>
        <tr>
          ...
          <td align="center"><a href="/court/view.php?id=<? echo $court->getCourtID() ?>">View</a></td>
         </tr>
    <? } } ?>
    </tbody>
  </table>
