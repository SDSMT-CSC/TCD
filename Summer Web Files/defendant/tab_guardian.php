<div id="parent-dialog" title="Add New Parent or Guardian">
      ...
      <tr>
        <td valign="top">
          <table>
            ...
            <tr>
              <td>Home Phone:</td>
              <td><input type="text" name="home-phone" class="phone" /></td>
            </tr>
            <tr>
              <td>Work Phone:</td>
              <td><input type="text" name="work-phone"  class="phone" /></td>
            </tr>
            <tr>
              <td>Employer:</td>
        ...
        <tr>
          <td valign="top">
            <table>
              ...
              <tr>
                <td>Home Phone:</td>
                <td><input type="text" name="home-phone" class="phone" value="<? echo $guardian->homePhone ?>" /></td>
              </tr>
              <tr>
                <td>Work Phone:</td>
                <td><input type="text" name="work-phone" class="phone" value="<? echo $guardian->workPhone ?>" /></td>
              </tr>
              <tr>
                <td>Employer:</td>
